...
import hotel.management.Reception;
import hotel.management.AddRoom;
import java.awt.*;
import javax.swing.*;
...
public class Dashboard extends JFrame{
    ...
    public Dashboard() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("hotel/management/images/third.jpg"));
        Image i2 = i1.getImage().getScaledInstance(1000, 700,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2); 
	JLabel NewLabel = new JLabel(i3);
	NewLabel.setBounds(0, 0, 1000, 700); 
        add(NewLabel);
        
        JLabel AirlineManagementSystem = new JLabel("WELCOME TO ANAND GROUPS OF HOTEL");
	AirlineManagementSystem.setForeground(Color.WHITE);
        AirlineManagementSystem.setFont(new Font("Tahoma", Font.PLAIN, 40));
	AirlineManagementSystem.setBounds(100, 60, 1000, 85);
